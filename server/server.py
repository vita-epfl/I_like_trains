...
if len(sys.argv) > 2:
    try:
        ...
        print(
            f"Invalid number of players value: {sys.argv[2]}. Using default: {DEFAULT_NB_PLAYERS_PER_ROOM}"
        )
...
class Server:
    ...
    def accept_clients(self):
        ...
        error_threshold = (
            3  # Number of consecutive errors before considering a client disconnected
        )
