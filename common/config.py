...
class ClientConfig(BaseModel):
    ...
    # Where your code is located. You should put your agent file in
    # common/agents/<username>-<additional name>.py to prevent
    # collisions between students at grading time.
    # E.g. common/agents/johndoe-v3.py
    agent_filename: str = Field(..., min_length=1)

    # The server enforces a timeout. This client side timeout is
    # for debugging purpose. In order for us to grade your agent,
    # you must respond in less than 150ms per move (excluding any network
    # time).
...
class ServerConfig(BaseModel):
    ...
    # Seed for random number generation. If 0, a random seed will be generated.
    seed: int = 0
    ...
    maps: dict[str, str] = {}  # map name to path
