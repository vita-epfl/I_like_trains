...
class BaseAgent(ABC):
    ...
    def __init__(self):
        ...
        # override self.sleep in child classes if you want to slow down your agent for
        # debugging purpose
        self.sleep: float = 0
        self.setup()
    ...
    def scipers(self) -> list[str]:
        """
        This method must return a list of sciper numbers.
        """

    @abstractmethod
    def teamname(self) -> str:
        """
        This method must return your team name.
        """
