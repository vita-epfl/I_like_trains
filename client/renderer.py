...
class Renderer:
    ...
    def __init__(self, config: ClientConfig, key_event: KeyEvent | None) -> None:
        pygame.init()
        self.config = config
    ...
    async def run_event_loop(self) -> None:
        ...
        while True:
            ...
            # Give as much time as possible to asyncio.sleep
            fps = 60
    ...
    def get_footer(self) -> str:
        ...
        if self.game_state is not None:
            ...
            if self.game_state.buses[self.slot].respawn_at > 0:
                ...
                footer.append(f"crashed (respawn in {max(t, 0)} ticks)")
        ...
        footer.insert(0, self.connection_state.value)
        return " | ".join(footer)
